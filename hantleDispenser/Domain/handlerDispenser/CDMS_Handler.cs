...
namespace HantleDispenserAPI
{
    ...
    {
        private static CDMS_Handler? _instance = null;
        public static string Portname = string.Empty;
        public static string Denominations = string.Empty;
        public static CDMS_Handler Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new(Portname, Denominations);
                }
                return _instance;
            }
        }
    ...
    public class CDMS_Response
    {
        ...
        public string UIResponse { get; set; } = string.Empty;
